webpackJsonp([9],Array(544).concat([
/* 544 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CodetribesPageModule", function() { return CodetribesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__codetribes__ = __webpack_require__(871);
...
var CodetribesPageModule = /** @class */ (function () {
    function CodetribesPageModule() {
    }
    CodetribesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__codetribes__["a" /* CodetribesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__codetribes__["a" /* CodetribesPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], CodetribesPageModule);
    return CodetribesPageModule;
}());

//# sourceMappingURL=codetribes.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CodetribesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_member_service__ = __webpack_require__(464);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var CodetribesPage = /** @class */ (function () {
    function CodetribesPage(navCtrl, navParams, membersService) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.filter = 'current';
        this.alumniCount = 0;
        this.promise = this.membersService.students().then(function (students) {
            _this.allstudents = students;
            _this.filtered('current');
            console.log(students);
        });
    }
    CodetribesPage.prototype.ionViewDidLoad = function () {
    };
    CodetribesPage.prototype.viewMember = function (student) {
        this.navCtrl.push('ProfilePage', { profile: student });
    };
    CodetribesPage.prototype.viewStartup = function (startup) {
        this.navCtrl.push('StartupPage', { startup: startup });
    };
    CodetribesPage.prototype.shorten = function (description) {
        var toReturn = description.split(' ');
        if (toReturn.length > 25) {
            return toReturn.slice(0, 25).join(' ') + ' ...';
        }
        return description;
    };
    CodetribesPage.prototype.filtered = function (filter) {
        var _this = this;
        this.alumniCount = 0;
        this.students = this.allstudents.filter(function (startup) {
            if (startup.alumni) {
                _this.alumniCount += 1;
            }
            if (filter == 'current') {
    ...
    CodetribesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-codetribes',template:/*ion-inline-start:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/codetribes/codetribes.html"*/'<!--\n  Generated template for the StartupsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Codetribers</ion-title>\n  </ion-navbar>\n\n  <ion-toolbar color="primary" no-border-top>\n    <ion-segment color="white" [(ngModel)]="filter">\n      <ion-segment-button color="white" value="current" (ionSelect)="filtered(\'current\')">\n        Current <ion-badge color="primary-dark">{{allstudents.length - alumniCount}}</ion-badge>\n      </ion-segment-button>\n      <ion-segment-button color="white" value="alumni" (ionSelect)="filtered(\'alumni\')">\n        Alumni <ion-badge color="primary-dark">{{alumniCount}}</ion-badge>\n      </ion-segment-button>\n    </ion-segment>\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let student of students" (click)="viewMember(student)">\n      <ion-avatar item-left>\n          <img src="assets/imgs/avatar.png">\n        </ion-avatar>\n      <h2>{{student.name}}</h2>\n      <p>{{student?.organization.name}}</p>\n    </button>\n  </ion-list>\n\n<div class="center-center" *ngIf="filter == \'alumni\' && students.length == 0">There are currently no Alumni</div>\n\n<loader [promise]="promise" dialog="false"></loader>'/*ion-inline-end:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/codetribes/codetribes.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__services_member_service__["a" /* MemberService */]])
    ], CodetribesPage);
    return CodetribesPage;
}());

//# sourceMappingURL=codetribes.js.map
