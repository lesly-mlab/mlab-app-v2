webpackJsonp([2],Array(560).concat([
/* 560 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__share__ = __webpack_require__(888);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_reports_service__ = __webpack_require__(466);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SharePage = /** @class */ (function () {
    function SharePage(navCtrl, alertController, formBuilder, navParams, reportService) {
        this.navCtrl = navCtrl;
        this.alertController = alertController;
        ...
        this.form = this.formBuilder.group({
            email: ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].email]]
        });
    ...
    SharePage.prototype.addPerson = function (recipient) {
        if (this.form.valid) {
    ...
    SharePage.prototype.removePerson = function (index) {
        this.recipients.splice(index, 1);
    };
    SharePage.prototype.share = function () {
        var _this = this;
        if (this.recipients.length > 0) {
            this.promise = this.reportService.share(this.report.id, this.recipients).then(function () {
                _this.navCtrl.pop();
            });
        }
    };
    SharePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-share',template:/*ion-inline-start:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/share/share.html"*/'\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Share</ion-title>\n</ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <form [formGroup]="form">\n    <div class="add" style= "margin-bottom: 10px;">\n      <input #input class="input-style" [(ngModel)]="recipient" placeholder="To:" formControlName="email" />\n      <ion-icon item-right id="icon-style" name="add" color="primary" (click)="addPerson(input)"></ion-icon>\n    </div>\n  </form>\n\n\n  <ion-list>\n    <div class="add" *ngFor="let recipient of recipients; let i = index">\n      <button style="flex: 1;" ion-item  >\n        {{ recipient }}\n      </button>  \n      <ion-icon  item-right id="icon-style" name="close" color="danger" (click)="removePerson(i)"></ion-icon>\n    </div>\n  </ion-list>\n</ion-content>\n<ion-footer padding no-border>\n  <button ion-button block outline (click)="share()">Share</button>\n</ion-footer>\n\n<loader [promise]="promise" progress="Sending Reports" success="Reports sent"></loader>'/*ion-inline-end:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/share/share.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__services_reports_service__["a" /* ReportsService */]])
    ], SharePage);
    return SharePage;
}());
