webpackJsonp([3],Array(558).concat([
/* 558 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reports__ = __webpack_require__(886);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_member_service__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_transfer__ = __webpack_require__(471);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_file__ = __webpack_require__(472);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_document_viewer__ = __webpack_require__(473);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_file_opener__ = __webpack_require__(474);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReportsPage = /** @class */ (function () {
    function ReportsPage(navCtrl, reportsService, firebase, userService, platform, iab, memberService, fileTransfer, file, documentViewer, fileOpener) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.reports = [];
        this.promise = reportsService.reports().then(function (reports) {
            return memberService.featured().then(function (startups) {
                _this.reports = reports;
                _this.startups = startups;
    ...
    ReportsPage.prototype.download = function (report) {
        ...
        this.platform.ready().then(function () {
            ...
            if (_this.platform.is('cordova')) {
                console.log('To SAVE: ' + _this.file.dataDirectory + report.name);
                _this.downloadPromise = _this.fileTransfer.create().download(report.url, _this.file.dataDirectory + report.name.split(' ').join('') + '-' + new Date().getDate() + '.pdf').then(function (entry) {
                    var url = entry.toURL();
                    console.log(url);
                    console.log('To open in inappbrowser');
                    return _this.fileOpener.open(url, 'application/pdf');
                }).catch(function (err) {
                    console.log(err);
                });
            }
            else {
                _this.iab.create(report.url);
            }
        });
    };
    ReportsPage.prototype.showStartup = function (startup) {
        this.navCtrl.push('StartupPage', { startup: startup });
    };
    ReportsPage.prototype.share = function (report) {
        this.navCtrl.push('SharePage', { report: report });
    };
    ReportsPage.prototype.bookmark = function () {
    };
    ReportsPage.prototype.sendEmail = function () {
        // sendgrid.setApiKey()
    };
    ReportsPage.prototype.registerPush = function () {
        var _this = this;
    ...
    ReportsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__services_reports_service__["a" /* ReportsService */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__ionic_native_in_app_browser__["a" /* InAppBrowser */], __WEBPACK_IMPORTED_MODULE_6__services_member_service__["a" /* MemberService */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_8__ionic_native_file__["a" /* File */],
            __WEBPACK_IMPORTED_MODULE_9__ionic_native_document_viewer__["a" /* DocumentViewer */], __WEBPACK_IMPORTED_MODULE_10__ionic_native_file_opener__["a" /* FileOpener */]])
    ], ReportsPage);
    return ReportsPage;
}());
