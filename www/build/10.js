webpackJsonp([10],Array(543).concat([
/* 543 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__change_password__ = __webpack_require__(870);
...
var ChangePasswordPage = /** @class */ (function () {
    function ChangePasswordPage(navCtrl, navParams, formBuilder, userService) {
        this.navCtrl = navCtrl;
        ...
        this.form = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({
            oldPassword: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required]),
            ...
            confirmPassword: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required, this.passwordMatch('password')])
        });
    }
    ...
    ChangePasswordPage.prototype.changePassword = function () {
        ...
        if (this.form.valid) {
            this.subimmited = true;
            this.promise = this.userService.changePassword(this.form.value.oldPassword, this.form.value.password).then(function () {
                _this.navCtrl.pop();
            });
        }
    };
    ChangePasswordPage.prototype.passwordMatch = function (field_name) {
