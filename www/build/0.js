webpackJsonp([0],Array(556).concat([
/* 556 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__notifications__ = __webpack_require__(883);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_json_experience_json__ = __webpack_require__(884);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_json_experience_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__assets_json_experience_json__);
throw new Error("Cannot find module \"../../components/chat-form/chat-form.component.js\"");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NotificationsPage = /** @class */ (function () {
    function NotificationsPage() {
        this.form = __WEBPACK_IMPORTED_MODULE_1__assets_json_experience_json__["default"];
    }
    NotificationsPage.prototype.dropdownList = function (id, formValues) {
        throw new Error("Method not implemented.");
    };
    NotificationsPage.prototype.dropdownEmpty = function () {
        throw new Error("Method not implemented.");
    };
    NotificationsPage.prototype.chatReady = function () {
        //this.chatForm.setChatListener(this);
        this.chatForm.setChatListener(this.chatForm.form);
        this.chatForm.start();
    };
    NotificationsPage.prototype.callAction = function (action, formValues) {
        // Actions called here
        // throw new Error("Method not implemented.");
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('chatForm'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__components_chat_form_chat_form_component_js__["ChatFormComponent"])
    ], NotificationsPage.prototype, "chatForm", void 0);
    NotificationsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-notifications',template:/*ion-inline-start:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/notifications/notifications.html"*/'<!--\n  Generated template for the NotificationsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  \n  <ion-navbar color="primary">\n    <ion-title>Notifications</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<div id="bg">\n    <chat-form #chatForm [form]="form" (onInit)="chatReady()"></chat-form>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/notifications/notifications.html"*/,
        }),
        __metadata("design:paramtypes", [])
    ], NotificationsPage);
...
module.exports = {"start":"greeting","greeting":{"type":"message","content":"Welcome to mLab - I am the mLab Bot","next":"letscreate"},"letscreate":{"type":"message","content":"I just want to get an update on how your business has been doing","next":"time"},"time":{"type":"options","content":"Do you have 10min to chat?","options":[{"text":"Yes","value":"yes","next":"teamChanges"},{"text":"No","value":"no","next":"selectdate"}]},"selectdate":{"type":"question","fieldType":"date","content":"On which day would be more suitable for us to continue with our conversation?","next":"done"},"teamChanges":{"type":"options","content":"Have you had any changes to your team(Founders, Employees) since our last conversation?","options":[{"text":"Founders","value":"Founders","next":"totalFounders"},{"text":"Employees","value":"Employees","next":"totalEmployees"},{"text":"Both","value":"Both","next":"totFounders"},{"text":"None","value":"None","next":"Message"}]},"totalFounders":{"type":"question","fieldType":"number","content":"Total number of founders?","next":"womenFounders"},"womenFounders":{"type":"question","fieldType":"number","content":"How many founders are women?","next":"blackFounders"},"blackFounders":{"type":"question","fieldType":"number","content":"How many founders are Black(based on BBBEE guidelines)?","next":"feedbackMessage"},"totalEmployees":{"type":"question","fieldType":"number","content":"Total number of Employees?","next":"womenEmployees"},"womenEmployees":{"type":"question","fieldType":"number","content":"How many employees are women?","next":"blackEmployees"},"blackEmployees":{"type":"question","fieldType":"number","content":"How many employees are Black(based on BBBEE guidelines)?","next":"feedbackMessage"},"totFounder":{"type":"question","fieldType":"number","content":"Total number of founders?","next":"black_Founder"},"black_Founder":{"type":"question","fieldType":"number","content":"How many founders are Black(based on BBBEE guidelines)?","next":"tot_Emp"},"tot_Emp":{"type":"question","fieldType":"number","content":"Total number of Employees?","next":"women_Emp"},"women_Emp":{"type":"question","fieldType":"number","content":"How many employees are women?","next":"black_Emp"},"black_Emp":{"type":"question","fieldType":"number","content":"How many employees are Black(based on BBBEE guidelines)?","next":"feedbackMessage"},"feedbackMessage":{"type":"message","content":"Okay, thanks for the updates on your team. Let's move to your business solutions","next":"totalUsers"},"Message":{"type":"message","content":"Alright, Now let's move to your business solutions","next":"totalUsers"},"totalUsers":{"type":"question","fieldType":"number","content":"Total users reached?","next":"totalActiveUsers"},"totalActiveUsers":{"type":"question","fieldType":"number","content":"Total active users to date?","next":"financeSection"},"financeSection":{"type":"message","content":"Thanks a lot for the updates on your business solutions. Let's move to your Financial solutions","next":"totalRevenue"},"totalRevenue":{"type":"question","fieldType":"number","content":"Total revenue to date?","next":"totalCapital"},"totalCapital":{"type":"question","fieldType":"number","content":"Total capital to date?","next":"totalFunds"},"totalFunds":{"type":"question","fieldType":"number","content":"Total funds leveraged to date e.g grants, prizes, equity, loans?","next":"highlightsSection"},"highlightsSection":{"type":"message","content":"Almost done, Now Let's move to your Your Big Hightlights","next":"biggestHighlights"},"biggestHighlights":{"type":"question","fieldType":"text","content":"What are your biggest highlights?","next":"challengesSection"},"challengesSection":{"type":"message","content":"Finally, we in the last section...","next":"challenges"},"challenges":{"type":"question","fieldType":"text","content":"What was your biggest challenge?","next":"challengesOvercoming"},"challengesOvercoming":{"type":"question","fieldType":"text","content":"How are you thinking of overcoming this challenges?","next":"fullUpdates"},"fullUpdates":{"type":"options","content":"Any other updates?","options":[{"text":"Yes","value":"yes","next":"fullFeedback"},{"text":"No","value":"No","next":"done"}]},"fullFeedback":{"type":"question","fieldType":"text","content":"Please give us a brief explanation below","next":"done"},"done":{"type":"message","content":"Thanks for taking the time to chat with me, I look forward to hear about your growth in our next chat. Bye for now..","next":"submit"},"submit":{"type":"action"}}
