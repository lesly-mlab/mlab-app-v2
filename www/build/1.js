...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StartupsPageModule", function() { return StartupsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__startups__ = __webpack_require__(892);
...
var StartupsPageModule = /** @class */ (function () {
    function StartupsPageModule() {
    }
    StartupsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__startups__["a" /* StartupsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__startups__["a" /* StartupsPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], StartupsPageModule);
    return StartupsPageModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StartupsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(68);
 ...
 */
var StartupsPage = /** @class */ (function () {
    function StartupsPage(navCtrl, navParams, membersService) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.alumniCount = 0;
        this.loading = true;
        this.promise = this.membersService.startups().then(function (startups) {
            _this.allstartups = startups;
            _this.filtered('current');
            console.log(startups);
            _this.loading = false;
        });
    }
    StartupsPage.prototype.ionViewDidLoad = function () {
    };
    StartupsPage.prototype.viewStartup = function (startup) {
        this.navCtrl.push('StartupPage', { startup: startup });
    };
    StartupsPage.prototype.shorten = function (description) {
        if (description) {
    ...
    StartupsPage.prototype.filtered = function (filter) {
        var _this = this;
        this.alumniCount = 0;
        this.startups = this.allstartups.filter(function (startup) {
            if (startup.alumni) {
                _this.alumniCount += 1;
            }
            if (filter == 'current') {
    ...
    StartupsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-startups',template:/*ion-inline-start:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/startups/startups.html"*/'<!--\n  Generated template for the StartupsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Startups</ion-title>\n  </ion-navbar>\n\n  <ion-toolbar color="primary" no-border-top>\n    <ion-segment color="white" [(ngModel)]="filter">\n      <ion-segment-button color="white" value="current" (ionSelect)="filtered(\'current\')">\n        Current <ion-badge color="primary-dark">{{allstartups.length - alumniCount}}</ion-badge>\n      </ion-segment-button>\n      <ion-segment-button color="white" value="alumni" (ionSelect)="filtered(\'alumni\')">\n        Alumni <ion-badge color="primary-dark">{{alumniCount}}</ion-badge>\n      </ion-segment-button>\n    </ion-segment>\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content>\n  <!-- <ion-list>\n    <button ion-item *ngFor="let startup of startups" (click)="viewStartup(startup)">\n      <h2>{{startup.name}}</h2>\n      <p>{{startup.description}}</p>\n    </button>\n  </ion-list> -->\n\n  <ion-list >\n  <ion-card *ngFor="let startup of startups" (click)="viewStartup(startup)">\n      <img id="feature" [ngStyle]="{\'background-image\': \'url(\' + (startup.cover ? startup.cover : \'../assets/imgs/placeholder.jpg\') + \')\'}"/>\n      <ion-card-content>\n        <ion-card-title>\n          {{startup.name}}\n          <!-- <span class="location">{{startup.locationName}}</span> -->\n          </ion-card-title>\n        <p>\n          {{shorten(startup.description)}}\n        </p>\n      </ion-card-content>\n    </ion-card>\n  </ion-list>\n\n  <div id="empty" *ngIf="startups.length == 0 && !loading">\n      <p>There are currently no startups to show</p>\n    </div>\n\n    <loader [promise]="promise" dialog="false"></loader>\n</ion-content>\n\n<div class="center-center" *ngIf="filter == \'alumni\' && startups.length == 0">There are currently no Alumni</div>\n'/*ion-inline-end:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/startups/startups.html"*/,
        }),
