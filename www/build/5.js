webpackJsonp([5],Array(555).concat([
/* 555 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__members__ = __webpack_require__(882);
...
var MembersPage = /** @class */ (function () {
    function MembersPage(navCtrl, navParams, membersService, zone) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.promise = this.membersService.members(this.startup.id).then(function (members) {
    ...
    MembersPage.prototype.viewMember = function (member) {
        this.navCtrl.push('ProfilePage', { profile: member });
    };
    MembersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-members',template:/*ion-inline-start:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/members/members.html"*/'<!--\n  Generated template for the MembersPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Members</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <ion-list>\n        <button ion-item *ngFor="let member of members" (click)="viewMember(member)">\n          <h2>{{member.name}}</h2>\n          <p>{{member.username}}</p>\n        </button>\n      </ion-list>\n      <loader [promise]="promise" dialog="false" emptyMessage="This startup doesn\'t have any members registered yet"></loader>\n</ion-content>'/*ion-inline-end:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/members/members.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__services_member_service__["a" /* MemberService */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"]])
    ], MembersPage);
    return MembersPage;
}());
