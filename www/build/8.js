webpackJsonp([8],Array(546).concat([
/* 546 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forgot_password__ = __webpack_require__(873);
...
var ForgotPasswordPage = /** @class */ (function () {
    function ForgotPasswordPage(navCtrl, alertController, navParams, userService, formBuilder) {
        this.navCtrl = navCtrl;
        this.alertController = alertController;
        ...
        this.form = formBuilder.group({
            email: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].email]]
        });
    }
    ...
    ForgotPasswordPage.prototype.reset = function () {
        var _this = this;
        if (this.form.valid) {
            this.promise = this.userService.passwordReset(this.email).then(function (password) {
                _this.alertController.create({
                    title: "Success",
    ...
    ForgotPasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-forgot-password',template:/*ion-inline-start:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/forgot-password/forgot-password.html"*/'<!--\n  Generated template for the ForgotPasswordPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      Forgot Password\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding >\n\n  <form [formGroup]="form" novalidate>\n      <div class="center">\n        <img src="assets/imgs/mlab-logo.png" />\n      </div>\n  <ion-item>\n    <ion-label floating>Email<br><span class="error" *ngIf="form.get(\'email\').hasError(\'required\') && form.get(\'email\').touched">Please enter a valid email</span></ion-label>\n    <ion-input type="email" [(ngModel)]="email" formControlName="email"></ion-input>\n  </ion-item>\n</form> \n    <button (click)="reset()" ion-button block color="secondary" style="margin-bottom: 10px">Reset</button>\n   \n</ion-content>\n<loader progress="sending.." [promise]="promise"></loader>\n'/*ion-inline-end:"/home/codetribe/Documents/Angular-Projects/mlab-app-v2/src/pages/forgot-password/forgot-password.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__services_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormBuilder */]])
    ], ForgotPasswordPage);
