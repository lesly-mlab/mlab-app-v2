...
dpd.admins = dpd("/admins");
dpd.admins.login = function(path, body, fn) {
  return dpd.admins.exec("login", path, body, fn);
}
dpd.admins.logout = function(path, body, fn) {
  return dpd.admins.exec("logout", path, body, fn);
}
dpd.admins.me = function(path, query, fn) {
  return dpd.admins.get("me", path, query, fn);
}
dpd.admins.on = function(ev, fn) {
  return dpd.on("admins" + ":" + ev, fn);
}
dpd.admins.once = function(ev, fn) {
  return dpd.once("admins" + ":" + ev, fn);
}
dpd.admins.off = function(ev, fn) {
  return dpd.off("admins" + ":" + ev, fn);
}

dpd.bookmarks = dpd("/bookmarks");
dpd.bookmarks.on = function(ev, fn) {
  return dpd.on("bookmarks" + ":" + ev, fn);
}
dpd.bookmarks.once = function(ev, fn) {
  return dpd.once("bookmarks" + ":" + ev, fn);
}
dpd.bookmarks.off = function(ev, fn) {
  return dpd.off("bookmarks" + ":" + ev, fn);
}
dpd.bookmarks.rename = function (path, body, fn) {
  dpd.bookmarks.exec("rename", path, body, fn);
}

dpd.categories = dpd("/categories");
dpd.categories.on = function(ev, fn) {
  return dpd.on("categories" + ":" + ev, fn);
}
dpd.categories.once = function(ev, fn) {
  return dpd.once("categories" + ":" + ev, fn);
}
dpd.categories.off = function(ev, fn) {
  return dpd.off("categories" + ":" + ev, fn);
}
dpd.categories.rename = function (path, body, fn) {
  dpd.categories.exec("rename", path, body, fn);
}

dpd.confirmpasswordreset = dpd("/confirmpasswordreset");
dpd.confirmpasswordreset.on = function(ev, fn) {
  return dpd.on("confirmpasswordreset" + ":" + ev, fn);
}
dpd.confirmpasswordreset.once = function(ev, fn) {
  return dpd.once("confirmpasswordreset" + ":" + ev, fn);
}
dpd.confirmpasswordreset.off = function(ev, fn) {
  return dpd.off("confirmpasswordreset" + ":" + ev, fn);
}

dpd.devices = dpd("/devices");
dpd.devices.on = function(ev, fn) {
  return dpd.on("devices" + ":" + ev, fn);
}
dpd.devices.once = function(ev, fn) {
  return dpd.once("devices" + ":" + ev, fn);
}
dpd.devices.off = function(ev, fn) {
  return dpd.off("devices" + ":" + ev, fn);
}
dpd.devices.rename = function (path, body, fn) {
  dpd.devices.exec("rename", path, body, fn);
}

dpd.downloadreport = dpd("/downloadreport");
dpd.downloadreport.on = function(ev, fn) {
  return dpd.on("downloadreport" + ":" + ev, fn);
}
dpd.downloadreport.once = function(ev, fn) {
  return dpd.once("downloadreport" + ":" + ev, fn);
}
dpd.downloadreport.off = function(ev, fn) {
  return dpd.off("downloadreport" + ":" + ev, fn);
}

dpd.ethnicities = dpd("/ethnicities");
dpd.ethnicities.on = function(ev, fn) {
  return dpd.on("ethnicities" + ":" + ev, fn);
}
dpd.ethnicities.once = function(ev, fn) {
  return dpd.once("ethnicities" + ":" + ev, fn);
}
dpd.ethnicities.off = function(ev, fn) {
  return dpd.off("ethnicities" + ":" + ev, fn);
}
dpd.ethnicities.rename = function (path, body, fn) {
  dpd.ethnicities.exec("rename", path, body, fn);
}

dpd.genders = dpd("/genders");
dpd.genders.on = function(ev, fn) {
  return dpd.on("genders" + ":" + ev, fn);
}
dpd.genders.once = function(ev, fn) {
  return dpd.once("genders" + ":" + ev, fn);
}
dpd.genders.off = function(ev, fn) {
  return dpd.off("genders" + ":" + ev, fn);
}
dpd.genders.rename = function (path, body, fn) {
  dpd.genders.exec("rename", path, body, fn);
}

dpd.innovations = dpd("/innovations");
dpd.innovations.on = function(ev, fn) {
  return dpd.on("innovations" + ":" + ev, fn);
}
dpd.innovations.once = function(ev, fn) {
  return dpd.once("innovations" + ":" + ev, fn);
}
dpd.innovations.off = function(ev, fn) {
  return dpd.off("innovations" + ":" + ev, fn);
}
dpd.innovations.rename = function (path, body, fn) {
  dpd.innovations.exec("rename", path, body, fn);
}

dpd.organizations = dpd("/organizations");
dpd.organizations.on = function(ev, fn) {
  return dpd.on("organizations" + ":" + ev, fn);
}
dpd.organizations.once = function(ev, fn) {
  return dpd.once("organizations" + ":" + ev, fn);
}
dpd.organizations.off = function(ev, fn) {
  return dpd.off("organizations" + ":" + ev, fn);
}
dpd.organizations.rename = function (path, body, fn) {
  dpd.organizations.exec("rename", path, body, fn);
}

dpd.reports = dpd("/reports");
dpd.reports.on = function(ev, fn) {
  return dpd.on("reports" + ":" + ev, fn);
}
dpd.reports.once = function(ev, fn) {
  return dpd.once("reports" + ":" + ev, fn);
}
dpd.reports.off = function(ev, fn) {
  return dpd.off("reports" + ":" + ev, fn);
}
dpd.reports.rename = function (path, body, fn) {
  dpd.reports.exec("rename", path, body, fn);
}

dpd.resetpassword = dpd("/resetpassword");
dpd.resetpassword.on = function(ev, fn) {
  return dpd.on("resetpassword" + ":" + ev, fn);
}
dpd.resetpassword.once = function(ev, fn) {
  return dpd.once("resetpassword" + ":" + ev, fn);
}
dpd.resetpassword.off = function(ev, fn) {
  return dpd.off("resetpassword" + ":" + ev, fn);
}

dpd.roles = dpd("/roles");
dpd.roles.on = function(ev, fn) {
  return dpd.on("roles" + ":" + ev, fn);
}
dpd.roles.once = function(ev, fn) {
  return dpd.once("roles" + ":" + ev, fn);
}
dpd.roles.off = function(ev, fn) {
  return dpd.off("roles" + ":" + ev, fn);
}
dpd.roles.rename = function (path, body, fn) {
  dpd.roles.exec("rename", path, body, fn);
}

dpd.share = dpd("/share");
dpd.share.on = function(ev, fn) {
  return dpd.on("share" + ":" + ev, fn);
}
dpd.share.once = function(ev, fn) {
  return dpd.once("share" + ":" + ev, fn);
}
dpd.share.off = function(ev, fn) {
  return dpd.off("share" + ":" + ev, fn);
}

dpd.stats = dpd("/stats");
dpd.stats.on = function(ev, fn) {
  return dpd.on("stats" + ":" + ev, fn);
}
dpd.stats.once = function(ev, fn) {
  return dpd.once("stats" + ":" + ev, fn);
}
dpd.stats.off = function(ev, fn) {
  return dpd.off("stats" + ":" + ev, fn);
}

dpd.surveys = dpd("/surveys");
dpd.surveys.on = function(ev, fn) {
  return dpd.on("surveys" + ":" + ev, fn);
}
dpd.surveys.once = function(ev, fn) {
  return dpd.once("surveys" + ":" + ev, fn);
}
dpd.surveys.off = function(ev, fn) {
  return dpd.off("surveys" + ":" + ev, fn);
}
dpd.surveys.rename = function (path, body, fn) {
  dpd.surveys.exec("rename", path, body, fn);
}
